<template>
  <section class="gva-section flex items-center justify-center overflow-hidden min-h-[calc(100vh_-_194px)] pt-[66px] px-6 pb-0 max-[860px]:min-h-[auto] max-[860px]:pt-[60px] max-[860px]:pb-[18px]">
    <div class="gva-container text-center flex flex-col items-center min-[861px]:translate-y-[20%] max-[860px]:w-[min(100%,300px)]">
      <h1 class="text-[clamp(34px,5vw,56px)] leading-[1.2] font-semibold tracking-[-0.02em] text-[#1a1a1a] mx-0 mt-0 mb-5 max-[860px]:hidden">
        用 AI 构建系统，让系统为 AI 工作
      </h1>
      ...
      <p class="text-[clamp(15px,1.5vw,18px)] leading-[2] text-[#808080] max-w-[760px] mt-10 mx-0 mb-[30px] max-[860px]:hidden">
