<template>
  <section
    class="gva-section !bg-white !py-[72px] sm:!py-[112px] lg:!py-[128px] xl:!pt-[152px] xl:!pb-[156px]"
  >
    <!-- 完整保留项目原有版心 -->
    <div class="gva-container">
      ...
      >
        ...
        <!-- 桌面端正文：保持原样 -->
        <p
          class="gva-lead !mx-auto !mb-0 hidden !max-w-[1220px] !text-[16px] !font-normal !leading-[1.8] !tracking-[0.025em] !text-[#747981] min-[860px]:block sm:!mt-[32px] sm:!text-[14px] lg:!mt-[36px] lg:!text-[16px] xl:!mt-[38px] xl:!text-[16px] xl:!whitespace-nowrap"
        >
      ...
      >
        ...
        >
          ...
          <div class="min-w-0 pt-[3px]">
            <h4
              class="!m-0 text-[20px] font-semibold leading-[1.3] tracking-[-0.02em] text-[#080A0E]"
            >
              {{ s.title }}
            </h4>

            <p
              class="!mx-0 !mb-0 mt-[12px] text-[14px] font-normal leading-[1.72] tracking-[0.01em] text-[#747981]"
            >
      ...
      >
        ...
        >
          ...
          <!-- 标题向上压进数字渐隐区域 -->
          <h4
            class="apicli__title relative z-10 !mx-auto !mb-0 !mt-[-8px] w-fit !text-[20px] !font-semibold !leading-[1.3] !tracking-[-0.025em] !text-[#080A0E] sm:!text-[22px] lg:!text-[24px] xl:!text-[27px]"
          >
            {{ s.title }}
          </h4>
          ...
          <!-- 描述 -->
          <p
            class="apicli__desc !mx-auto !mb-0 !mt-[28px] max-w-[230px] !text-[15px] !font-normal !leading-[2] !tracking-[0.015em] !text-[#747981] sm:!text-[16px] lg:!mt-[32px] lg:!text-[17px] xl:!mt-[36px] xl:max-w-[250px] xl:!text-[18px] xl:!leading-[2.15]"
          >
            {{ s.mDesc[0] }}<br />{{ s.mDesc[1] }}
          </p>
        </li>
